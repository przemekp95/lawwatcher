    ...
    LegalCorpusCommandService commandService) : IHostedService
{
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var citActId = Guid.Parse("4F7610ED-6E4C-432F-8D95-1B3BE1E0DDBF");
        ...
        await commandService.AttachArtifactAsync(new AttachActArtifactCommand(
            citActId,
            "text",
            "acts/DU/2026/501/text.txt"), cancellationToken);

        var vatActId = Guid.Parse("AA5177A4-D0A4-4B1E-8460-F7DDC6B01E89");
        await commandService.RegisterAsync(new RegisterActCommand(
            vatActId,
            vatBill.Id,
            vatBill.Title,
        ...
        await commandService.AttachArtifactAsync(new AttachActArtifactCommand(
            vatActId,
            "text",
            "acts/DU/2026/502/text.txt"), cancellationToken);
    }
